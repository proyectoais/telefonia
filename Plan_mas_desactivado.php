		...
		<div id="contenido">
			...
			<div id="espac_cont">
				...
				<div id="cantidad_llamdas">
					...
					<center><p style="font-size: 18px;font-weight: bold;">Plan mas desactivado<p></center>
					<?php 
						$link = mysql_connect("localhost", "root", NULL); 
						mysql_select_db("bd_ais", $link); 
						$result1 = mysql_query("SELECT Nombre FROM plan", $link); 
						echo "<table border = '1' style = 'margin: 0px 0px 0px 89px; width:300px;'> \n"; 
						echo "<tr style = 'height: 38px'><td style = 'font-size:18px'>Plan</td><td style = 'font-size:18px'>Cantidad de desactivaciones</td>
						</tr> \n"; 
