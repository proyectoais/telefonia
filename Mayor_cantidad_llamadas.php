			...
			<div id="espac_cont">
				...
				<div id="cantidad_llamdas" style="margin-top: 21px;margin-left: 36px;">
					<?php 
						...
						$result1 = mysql_query("SELECT Modelo FROM telefono", $link); 
						echo "<table border = '1' style = 'margin: 0px 0px 0px 89px; width:300px;'> \n"; 
						echo "<tr style = 'height: 38px'><td style = 'font-size:18px'>Modelo</td><td style = 'font-size:18px'>Cantidad de llamadas</td>
						</tr> \n"; 
