		...
		<div id="contenido">
			...
			<div id="espac_cont">
				...
				<div id="cantidad_llamdas">
					...
					<center><p style="font-size: 18px;font-weight: bold;">SVA mas desactivado<p></center>
					<?php 
						...
						echo "<tr style = 'height: 38px'><td style = 'font-size:18px'>SVA</td><td style = 'font-size:18px'>Cantidad de desactivaciones</td>
						</tr> \n"; 
